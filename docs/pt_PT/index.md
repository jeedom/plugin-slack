...
-   **Domínio** : nome de domínio do seu Slack (permite, em particular, se
...
-   **Destino** : não obrigatório, permite forçar o envio de um
...
-   **Canal** : não é necessário, vamos dizer ao Slack para enviar tudo
