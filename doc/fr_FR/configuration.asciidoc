...
Voila comment récuperer votre token pour que jeedom puisse envoyer des fichiers sur slack, et en particulier des captures des caméras par exemple. Tout d'abord il faut aller link::https://api.slack.com/web?sudo=1[ici], puis tout en bas aller sur :
